...
var PostgresConnector = /** @class */ (function (_super) {
    ...
    PostgresConnector.prototype.listSchemas = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, _super.prototype.listSchemas.call(this)];
                    case 1:
                        schemas = _a.sent();
    ...
    PostgresConnector.prototype.queryColumnComment = function (schemaName, tableName, columnName) {
        return __awaiter(this, void 0, void 0, function () {
            var commentQuery, _a, comment;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.query(commentQuery, [
                                schemaName,
                                tableName,
                                columnName,
                            ])];
                    case 1:
                        _a = __read.apply(void 0, [(_b.sent()).map(function (row) { return row.column_comment; }), 1]), comment = _a[0];
    ...
    PostgresConnector.prototype.queryIndices = function (schemaName, tableName) {
        return __awaiter(this, void 0, void 0, function () {
            var indexQuery;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.query(indexQuery, [schemaName, tableName])];
