...
var gqlAssert_1 = require("../../../../prisma-datamodel/dist/util/gqlAssert");
var RelationalConnector = /** @class */ (function () {
    ...
    RelationalConnector.prototype.introspect = function (schema) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _a = this.createIntrospectionResult;
                        return [4 /*yield*/, this.listModels(schema)];
                    case 1:
                        _b = [_c.sent()];
                        return [4 /*yield*/, this.listRelations(schema)];
                    case 2:
                        _b = _b.concat([_c.sent()]);
                        return [4 /*yield*/, this.listEnums(schema)];
                    case 3:
                        _b = _b.concat([_c.sent()]);
                        return [4 /*yield*/, this.listSequences(schema)];
    ...
    RelationalConnector.prototype.listModels = function (schemaName) {
        return __awaiter(this, void 0, void 0, function () {
            var e_1, _a, e_2, _b, tables, allTables, allTables_1, allTables_1_1, tableName, columns, columns_1, columns_1_1, column, _c, e_2_1, allIndices, secondaryIndices, _d, primaryKey, e_1_1;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 2:
                        ...
                        allTables_1 = __values(allTables), allTables_1_1 = allTables_1.next();
                        _e.label = 3;
                    case 3:
                        if (!!allTables_1_1.done) return [3 /*break*/, 15];
                        tableName = allTables_1_1.value;
                        return [4 /*yield*/, this.queryColumns(schemaName, tableName)];
                    case 4:
                        columns = _e.sent();
                        _e.label = 5;
                    case 5:
                        ...
                        _e.label = 6;
                    case 6:
                        if (!!columns_1_1.done) return [3 /*break*/, 9];
                        column = columns_1_1.value;
                        _c = column;
                        return [4 /*yield*/, this.queryColumnComment(schemaName, tableName, column.name)];
                    case 7:
                        _c.comment = _e.sent();
                        _e.label = 8;
                    case 8:
                    ...
                    case 11:
                        ...
                        return [7 /*endfinally*/];
                    case 12: return [4 /*yield*/, this.queryIndices(schemaName, tableName)];
                    case 13:
                        allIndices = _e.sent();
                        secondaryIndices = allIndices.filter(function (x) { return !x.isPrimaryKey; });
                        _d = __read(allIndices.filter(function (x) { return x.isPrimaryKey; }), 1), primaryKey = _d[0];
                        tables.push({
                            name: tableName,
                            columns: columns,
                        ...
                        _e.label = 14;
                    case 14:
                        allTables_1_1 = allTables_1.next();
                        return [3 /*break*/, 3];
                    ...
                    case 17:
                        try {
                            if (allTables_1_1 && !allTables_1_1.done && (_a = allTables_1.return)) _a.call(allTables_1);
                        }
                        finally { if (e_1) throw e_1.error; }
                        return [7 /*endfinally*/];
                    case 18: return [2 /*return*/, tables];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1: return [2 /*return*/, (_a.sent()).map(function (row) {
                            gqlAssert_1.default.raiseIf(row.table_name === undefined, 'Received `undefined` as table name.');
    ...
    RelationalConnector.prototype.queryColumns = function (schemaName, tableName) {
        return __awaiter(this, void 0, void 0, function () {
            var allColumnsQuery;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    return [2 /*return*/, (_a.sent()).map(function (row) {
                            gqlAssert_1.default.raiseIf(row.column_name === undefined, 'Received `undefined` as column name.');
                            gqlAssert_1.default.raiseIf(row.udt_name === undefined, 'Received `undefined` as data type.');
                            return {
