...
var SERVICE_NAME = 'prisma-temporary-service';
var SERVICE_STAGE = 'temporary-stage';
...
var PrismaDBClient = /** @class */ (function () {
    ...
    PrismaDBClient.prototype.setDatabaseType = function () {
        return __awaiter(this, void 0, void 0, function () {
            var primaryConnector, typeMap, databaseType;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        primaryConnector = (_a.sent()).data.serverInfo.primaryConnector;
                        typeMap = {
                        ...
                        databaseType = typeMap[primaryConnector];
                        if (!databaseType) {
    ...
    PrismaDBClient.prototype.replace = function (query, variables) {
        ...
        try {
            for (var _b = __values(variables.entries()), _c = _b.next(); !_c.done; _c = _b.next()) {
                ...
                var pattern = this.databaseType === prisma_datamodel_1.DatabaseType.postgres ? "\\$" + (index + 1) : '\\?';
    ...
    PrismaDBClient.prototype.connect = function () {
        return __awaiter(this, void 0, void 0, function () {
            var cluster, endpoint, secretsBackup, token;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.definition.getCluster()];
                    case 1:
                        cluster = _a.sent();
                        if (!cluster) {
                        ...
                        return [4 /*yield*/, this.setDatabaseType()];
                    case 2:
                        _a.sent();
