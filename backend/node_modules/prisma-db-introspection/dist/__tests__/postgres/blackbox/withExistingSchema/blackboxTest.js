...
function blackBoxTest(name) {
    return __awaiter(this, void 0, void 0, function () {
        var modelPath, sqlDumpPath, model, sqlDump, parser, refModel, client, connector, introspectionResult, unnormalized, normalizedWithoutReference, normalizedWithReference, legacyRenderer, legacyRenderedWithReference, renderer, renderedWithReference;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    modelPath = path.join(relativeTestCaseDir, name + "/model_relational_v1.1.graphql");
                    sqlDumpPath = path.join(relativeTestCaseDir, name + "/postgres.sql");
                    ...
                    connector = new postgresConnector_1.PostgresConnector(client);
                    return [4 /*yield*/, client.connect()];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, client.query("DROP SCHEMA IF EXISTS \"schema-generator$" + name + "\" cascade;")];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, client.query(sqlDump)];
                case 3:
                    _a.sent();
...
var _loop_1 = function (testName) {
    test("Introspects " + testName + "/relational correctly", function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
