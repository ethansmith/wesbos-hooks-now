...
function createAndIntrospect(schemaSql, schemaName, createSchema) {
    ...
    if (createSchema === void 0) { createSchema = true; }
    return __awaiter(this, void 0, void 0, function () {
        var client, dml, renderer, rendered, legacyRenderer, legacyRendered;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, client.query("DROP SCHEMA IF EXISTS \"" + schemaName + "\" cascade;")];
                case 2:
                    _a.sent();
                    if (!createSchema) return [3 /*break*/, 5];
                    return [4 /*yield*/, client.query("CREATE SCHEMA \"" + schemaName + "\";")];
                case 3:
                    _a.sent();
                    return [4 /*yield*/, client.query("SET search_path TO \"" + schemaName + "\";")];
                case 4:
                    _a.sent();
                    _a.label = 5;
                case 5: return [4 /*yield*/, client.query(schemaSql)];
                case 6:
                    _a.sent();
                    return [4 /*yield*/, connectors_1.default.create(prisma_datamodel_1.DatabaseType.postgres, client).introspect(schemaName)];
                case 7:
