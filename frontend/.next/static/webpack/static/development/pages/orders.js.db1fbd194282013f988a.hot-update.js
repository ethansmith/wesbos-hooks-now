...
/* harmony import */ var _components_OrdersList__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/OrdersList */ "./components/OrdersList.js");
...
var ALL_ORDERS_QUERY = graphql_tag__WEBPACK_IMPORTED_MODULE_3___default()(_templateObject());
...
var Orders = function Orders(props) {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_User__WEBPACK_IMPORTED_MODULE_4__["default"], {
    ...
    var data = _ref.data,
        ...
        error = _ref.error;
    console.log("the userId is", data.me.id);
    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_OrdersList__WEBPACK_IMPORTED_MODULE_1__["default"], {
      __source: {
        fileName: _jsxFileName,
        lineNumber: 26
      },
      __self: this
    }); //   return <Query query={ALL_ORDERS_QUERY} />
  });
};
...
//# sourceMappingURL=orders.js.db1fbd194282013f988a.hot-update.js.map