...
// CONCATENATED MODULE: ./components/OrdersList.js
...
var OrdersList_OrdersList = function OrdersList(props) {
  return external_react_default.a.createElement("div", null, external_react_default.a.createElement("h2", null, "You have ", props.orders.length, " orders"), external_react_default.a.createElement("orderUl", null, props.orders.map(function (order) {
...
/* harmony default export */ var components_OrdersList = (OrdersList_OrdersList);
...
var ALL_ORDERS_QUERY = external_graphql_tag_default()(_templateObject());
...
var orders_Orders = function Orders(props) {
  return external_react_default.a.createElement(User["b" /* default */], null, function (_ref) {
    var data = _ref.data,
        loading = _ref.loading,
        error = _ref.error;
    return external_react_default.a.createElement(PleaseSignIn["a" /* default */], null, external_react_default.a.createElement(external_react_apollo_["Query"], {
      ...
      return external_react_default.a.createElement(external_react_default.a.Fragment, null, external_react_default.a.createElement(ErrorMessage["a" /* default */], {
        error: error
      }), external_react_default.a.createElement(components_OrdersList, {
        orders: data.orders
      }));
    }));
  });
...
/* harmony default export */ var orders = __webpack_exports__["default"] = (orders_Orders);
