...
var RESET_PASSWORD = external_graphql_tag_default()(_templateObject());
...
var ResetPassword_ResetPassword = function ResetPassword(props) {
  ...
  return external_react_default.a.createElement(external_react_apollo_["Mutation"], {
    ...
    return external_react_default.a.createElement(Form["a" /* default */], {
      ...
      disabled: loading,
      "aria-busy": loading
    }, external_react_default.a.createElement("h2", null, "Reset your password"), !error && !loading && called && external_react_default.a.createElement("p", null, "Awesome! Your password has been changed"), external_react_default.a.createElement("label", {
      htmlFor: "password"
...
var reset_Reset = function Reset(props) {
  return external_react_default.a.createElement(components_ResetPassword, {
