...
var UpdateItem_UpdateItem = function UpdateItem(props) {
  var _useState = Object(external_react_["useState"])(props),
  ...
  function () {
    ...
    return function runUpdateItem(_x, _x2) {
    ...
    return external_react_default.a.createElement(external_react_apollo_["Mutation"], {
      ...
      return external_react_default.a.createElement(Form["a" /* default */], {
        onSubmit: function onSubmit(e) {
          return runUpdateItem(e, updateItem);
        }
...
var update_Update = function Update(props) {
  return external_react_default.a.createElement("div", null, external_react_default.a.createElement("p", null, "This is the Update page ", props.query.id && "for the item with ID of: ".concat(props.query.id), "!"), external_react_default.a.createElement(components_UpdateItem, {
    id: props.query.id
  }));
};
