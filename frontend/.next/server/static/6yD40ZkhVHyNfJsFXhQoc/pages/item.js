...
var SingleItem_SingleItem = function SingleItem(props) {
  var _useQuery = Object(external_react_apollo_hooks_["useQuery"])(SINGLE_ITEM_QUERY, {
    variables: {
      id: props.id
    }
  }),
  ...
  if (!data.item) return external_react_default.a.createElement("p", null, "No Item Found for ", props.id);
  var item = data.item;
  console.log(item);
  console.log(false);
