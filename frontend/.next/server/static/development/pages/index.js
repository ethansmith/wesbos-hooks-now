...
const Item = ({
  item
}) => __jsx(_styles_ItemStyles__WEBPACK_IMPORTED_MODULE_5__["default"], {
  __source: {
    fileName: _jsxFileName,
    lineNumber: 12
  },
  ...
  __self: undefined
}), __jsx(_styles_Title__WEBPACK_IMPORTED_MODULE_4__["default"], {
  __source: {
    fileName: _jsxFileName,
    lineNumber: 14
  },
  ...
  __self: undefined
}, item.title))), __jsx(_styles_PriceTag__WEBPACK_IMPORTED_MODULE_6__["default"], {
  __source: {
    fileName: _jsxFileName,
    lineNumber: 22
  },
  __self: undefined
}, Object(_lib_formatMoney__WEBPACK_IMPORTED_MODULE_7__["default"])(item.price)), __jsx("p", {
  __source: {
    fileName: _jsxFileName,
    lineNumber: 25
  },
  ...
  __self: undefined
}, "Edit \u270F")), __jsx(_AddToCart__WEBPACK_IMPORTED_MODULE_9__["default"], {
  item: item,
  __source: {
    fileName: _jsxFileName,
    lineNumber: 33
...
const Items = props => __jsx(Center, {
  __source: {
    fileName: _jsxFileName,
    lineNumber: 34
  },
...
const Pagination = props => __jsx(react_apollo__WEBPACK_IMPORTED_MODULE_4__["Query"], {
  query: PAGINATION_QUERY,
  __source: {
    fileName: _jsxFileName,
    lineNumber: 19
  ...
  const totalPages = Math.ceil(itemsCount / _config__WEBPACK_IMPORTED_MODULE_5__["perPage"]);
  ...
  return __jsx(_styles_PaginationStyles__WEBPACK_IMPORTED_MODULE_6__["default"], {
    ...
    __self: undefined
  }, "Sick Fits + - Page ", props.page, " of ", totalPages, ' ')), __jsx(next_link__WEBPACK_IMPORTED_MODULE_3___default.a, {
    prefetch: true,
    href: {
      pathname: 'items',
      query: {
    ...
    __self: undefined
  }, itemsCount, " items total"), __jsx(next_link__WEBPACK_IMPORTED_MODULE_3___default.a, {
    prefetch: true,
    href: {
      pathname: 'items',
      query: {
...
const Home = props => __jsx("div", {
  ...
  __self: undefined
}, __jsx(_components_Items__WEBPACK_IMPORTED_MODULE_3__["default"], {
...
module.exports = __webpack_require__(/*! /Users/ethan/Sites/wpx/wesbos-hooks-now/frontend/pages/index.js */"./pages/index.js");
