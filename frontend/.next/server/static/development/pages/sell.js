...
const Dropzone = styled_components__WEBPACK_IMPORTED_MODULE_8___default.a.div.withConfig({
...
const CREATE_ITEM_MUTATION = graphql_tag__WEBPACK_IMPORTED_MODULE_4___default.a`
...
const CreateItem = props => {
  ...
  const {
    ...
    onDrop: acceptedFiles => {
      setFiles(acceptedFiles.map(file => _babel_runtime_corejs2_core_js_object_assign__WEBPACK_IMPORTED_MODULE_2___default()(file, {
  ...
  const {
    0: uploading,
    1: setUploading
  } = Object(react__WEBPACK_IMPORTED_MODULE_3__["useState"])(false); // const uploadFile = async e => {
  ...
  return __jsx(react_apollo__WEBPACK_IMPORTED_MODULE_6__["Mutation"], {
    mutation: CREATE_ITEM_MUTATION,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 191
    ...
    loading,
    error
  }) => __jsx(_styles_Form__WEBPACK_IMPORTED_MODULE_10__["default"], {
    onSubmit: async e => {
      ...
      const res = await createItem({
        variables: {
          title: theTitle,
          price: _babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_1___default()(thePrice),
    ...
    __self: undefined
  }, __jsx(Dropzone, Object(_babel_runtime_corejs2_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({}, getRootProps({
    isDragActive,
    isDragAccept,
    isDragReject
  }, {
...
var _jsxFileName = "/Users/ethan/Sites/wpx/wesbos-hooks-now/frontend/components/PleaseSignIn.js";
...
const SignIn = props => {
  ...
  return __jsx(react_apollo__WEBPACK_IMPORTED_MODULE_2__["Mutation"], {
    ...
    if (error) return __jsx(_ErrorMessage__WEBPACK_IMPORTED_MODULE_5__["default"], {
      error: error,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 35
...
var _jsxFileName = "/Users/ethan/Sites/wpx/wesbos-hooks-now/frontend/pages/sell.js";
...
const Sell = props => __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx(_components_PleaseSignIn__WEBPACK_IMPORTED_MODULE_3__["default"], {
  __source: {
    fileName: _jsxFileName,
    lineNumber: 7
  },
...
module.exports = __webpack_require__(/*! /Users/ethan/Sites/wpx/wesbos-hooks-now/frontend/pages/sell.js */"./pages/sell.js");
