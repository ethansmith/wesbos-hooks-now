...
if(!hasModern&&source.indexOf('module.exports')!==-1){options.plugins.push(applyCommonJs);}options.plugins.push(['transform-define',{'typeof window':isServer?'undefined':'object'},'next-js-transform-define-instance']);// As next-server/lib has stateful modules we have to transpile commonjs
